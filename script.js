...
function onEnterClicked() {
    ...
    for (let index = 0; index < 5; index++) {
        ...
        if (guessedLetter == wordArray[index]) {
            document.getElementById("r" + row + "c" + (index + 1)).style.backgroundColor = "green";
            score++;
        }
        else if (wordArray.includes(guessedLetter)) {
            document.getElementById("r" + row + "c" + (index + 1)).style.backgroundColor = "yellow";
        }
        else {
            document.getElementById("r" + row + "c" + (index + 1)).style.backgroundColor = "red";
        }
    }
